...
class _TensorAbi(Protocol):
    @property
    def name(self) -> str: ...


class _GraphMetadata(Protocol):
    @property
    def properties(self) -> Mapping[str, Any]: ...

    @property
    def input_abi(self) -> tuple[_TensorAbi, ...]: ...
...
def resolve_input_devices(metadata: _GraphMetadata) -> tuple[torch.device, ...]:
