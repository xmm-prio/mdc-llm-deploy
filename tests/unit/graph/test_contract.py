...
def test_graph_package_contract_exports_preserve_identity(name: str) -> None:
    ...
    result = subprocess.run(
        [
            ...
            (
                ...
                "import mdc_llm_deploy.graph.contract; "
                "assert 'torch' not in sys.modules"
            ),
        ],
        cwd=project_root,
...
def test_onnx_activation_qparams_accept_frozen_mapping_and_tuples() -> None:
    from mdc_llm_deploy.onnx.transform.support import activation_target
